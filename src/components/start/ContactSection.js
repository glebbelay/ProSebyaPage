    ...
    <div>
            ...
            <div class="contact_main">
                <div class="input">
                    <form action="contact">
                        <div class="name">
                            ...
                            <input type="text" placeholder="Иван Иванов" id="username"/>
                        </div>
                        <div class="email">
                        ...
                        <div class="email">
                            ...
                            <input type="email" placeholder="@ivan31" id="useremail"/>
                        </div>
                        <div class="textarea">
                ...
                <div class="details">
                    ...
                    <div class="details_text" style={{marginTop: "135px"}}>
